<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trends.aspx.cs" Inherits="ThreadCo.Trends" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="new-arrivals-section">
              <h2 class="new-arrivals-heading">Trending Now</h2>
             <hr>
                <div class="products">
                    <asp:Repeater ID="RepeaterProducts" runat="server">
                        <ItemTemplate>
                            <div class="product">
                                ...
                                <a href='Products.aspx?id=<%# Eval("Id") %>' class="Add_to_cart">View Details</a>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
